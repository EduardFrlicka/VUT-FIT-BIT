...
\author{Eduard Frlička \\ \href{mailto:xfrlic00@fit.vutbr.cz}{xfrlic00@fit.vutbr.cz}}
\date{}
...
V~češtině se používají uvozovky typu ,,9966`` místo anglických ``uvozovek'' nebo dvojitých "uvozovek".
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{http://petr.olsak.net/ftp/olsak/vlna/}}.
...
Sekce \ref{sec-smisena_sadzba} a \ref{sec-Dalsi_rady} obsahují typografické chyby.
