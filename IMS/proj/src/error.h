...
#define __CLEAN_LINE                                                                                                                                                                                   \
    struct winsize __w;                                                                                                                                                                                \
    ioctl(STDOUT_FILENO, TIOCGWINSZ, &__w);                                                                                                                                                            \
    fprintf(stderr, "\r%*s\r", __w.ws_col, "");

#define ERROR(code, ...)                                                                                                                                                                               \
    do {                                                                                                                                                                                               \
        __CLEAN_LINE                                                                                                                                                                                   \
        __ERROR(code, __VA_ARGS__);                                                                                                                                                                    \
    } while (0)

#define WARNING(...)                                                                                                                                                                                   \
    do {                                                                                                                                                                                               \
        __CLEAN_LINE                                                                                                                                                                                   \
        __WARNING(__VA_ARGS__);                                                                                                                                                                        \
    } while (0)
