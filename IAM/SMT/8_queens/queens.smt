...
;============================= START ==============
(assert (forall ((k Int)) (forall ((l Int)) (=> (is-in-range k) (=> (pos k l) (forall ((m Int)) (=> (and (is-in-range m) (is-in-range (+ (- m k) l))) (=> (not (= k m)) (not (pos m (+ (- m k) l)))))))) )))
(assert (forall ((k Int)) (forall ((l Int)) (=> (is-in-range k) (=> (pos k l) (forall ((m Int)) (=> (and (is-in-range m) (is-in-range (- l (- m k)))) (=> (not (= k m)) (not (pos m (- l (- m k))))))))) ))) 
;============================= END ================
